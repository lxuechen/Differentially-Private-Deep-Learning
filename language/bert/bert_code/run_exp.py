...
# python run_exp.py --ckpt_dir /nlp/scr/lxuechen/rgp-ckpts/checkpoint_best.pt --batch_size 1000 --epoch 50 --gpu_id 0 --seed 0  --lr 3e-4 --eps 8 --delta 1e-5 --clip 10 --rank 1 --epoch 50 --sess debug_sst2 --to_console
